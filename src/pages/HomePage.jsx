    ...
    <Stack
      ...
      >
        ...
        <Stack flex={1} spacing={{ base: 5, md: 10 }}>
          ...
          <Text color={"gray.500"} fontSize={"lg"}>
            With <span style={{ fontWeight: "bold" }}>spendwise</span> , you can
            easily track your{" "}
            <span style={{ fontWeight: "bold" }}>expenses</span>, set{" "}
            <span style={{ fontWeight: "bold" }}>budget</span> goals, and take
      ...
      >
        ...
        <Stack flex={1} spacing={{ base: 5, md: 10 }}>
          ...
          <Text color={"gray.500"} fontSize={"lg"}>
            <span style={{ fontWeight: "bold" }}>spendwise</span> helps you stay
            on top of your spending, providing you with the insights and tools
            you need to achieve{" "}
